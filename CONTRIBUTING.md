<!-- generated-from:9dc1188606a39c74519691c1d6966c7917c5c40bc2d47240dbb3878841426d11 DO NOT REMOVE, DO UPDATE -->
...
Please review our [Code of Conduct](https://github.com/moovfinancial/ach/blob/master/CODE_OF_CONDUCT.md) to ensure you agree with the values of this project.
...
```
$ midir -p $GOPATH/src/github.com/moovfinancial/
$ cd $GOPATH/src/github.com/moovfinancial/
$ git clone git@github.com:moovfinancial/ach-test-harness.git
```
...
First, [Fork our project](https://github.com/moovfinancial/ach-test-harness) somewhere and after that's done add the remote:

```
$ cd $GOPATH/src/github.com/moovfinancial/ach-test-harness # Whereever this project's source code is
...
Our Build pipeline utilizes [Github Actions](https://github.com/moovfinancial/ach-test-harness/actions) to enforce many tools that you should add to your editor before issuing a pull request.
